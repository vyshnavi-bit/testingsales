...
public class SalesDBManager
{
    ...
    //  public string UserName = "";
      ...
      string strcon = ConfigurationManager.ConnectionStrings["samuday360"].ConnectionString;
      public SalesDBManager()
      {
          //conn.ConnectionString = @" SERVER=sqlserver.cd3c9rp8jqjc.ap-south-1.rds.amazonaws.com;DATABASE=Samuday;UID=admin;PASSWORD=sqlserver";
          conn.ConnectionString = strcon;
         //conn.ConnectionString = @" SERVER=192.168.0.3;DATABASE=Samuday;UID=sa;PASSWORD=technowell";
      }
